...
supplied. `--group core` selects `verso.core.toml`. The directory containing the selected file becomes
the release root: package patterns, manifests, changelog, hooks, and Git commands all resolve from
there.
